...
var GameBl = /** @class */ (function () {
    function GameBl() {
    }
    GameBl.getGame = function (gameName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, DB_1.DB.Models.Game.findOne({ gameName: gameName }).populate("challenges")];
                    case 1:
                        game = _a.sent();
                        if (!game) {
...
exports.default = GameBl;
//# sourceMappingURL=gameBl.js.map