...
var UsereBl = /** @class */ (function () {
    function UsereBl() {
    }
    UsereBl.login = function (username, password, language) {
        return __awaiter(this, void 0, void 0, function () {
            var user, errorMessage, accessToken, respone, e_1;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_1 = _a.sent();
                        field = err_1.message.split('.$')[1].split(' dup key')[0];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_2 = _a.sent();
                        field = err_2.message.split('.$')[1].split(' dup key')[0];
                        throw new Error("looks like someone already used that " + field.substring(0, field.lastIndexOf('_')));
                    case 5: return [2 /*return*/];
                }
            });
