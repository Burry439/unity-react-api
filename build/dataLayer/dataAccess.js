...
var dataAccess = {
    ...
    post: function (modelType, entity) {
        return __awaiter(this, void 0, void 0, function () {
            var model, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    update: function (modelType, filters, entity) {
        return __awaiter(this, void 0, void 0, function () {
            var model, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, model.updateMany(filters, entity)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
    ...
    delete: function (modelType, filters) {
        return __awaiter(this, void 0, void 0, function () {
            var model, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        model = require("./models/" + modelType);
                        return [4 /*yield*/, model.remove(filters)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
